...
export default function PopupAddProject({
  ...
  const [techNameProject, setTechNameProject] = React.useState([]);
  const handleChangeTech = (event) => {
    setTechNameProject(event.target.value);
  };

  const [centerNameProject, setCenterNameProject] = React.useState([]);
  const handleChangeCenter = (event) => {
    setCenterNameProject(event.target.value);
  };

  const [staffNameProject, setStaffNameProject] = React.useState([]);
  const handleChangeStaff = (event) => {
    setStaffNameProject(event.target.value);
  };

  const [statusNameProject, setStatusNameProject] = React.useState('');
