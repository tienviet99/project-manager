              ...
              <Table size="small" aria-label="purchases">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell style={{fontWeight:'600',fontSize:'medium'}}>Mô tả</TableCell>
                    ...
                    <TableCell align="center" style={{fontWeight:'600',fontSize:'medium'}}>Nhân viên</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                <TableRow key={row.id}>
      ...
      <Table className={classes.table} aria-label="simple table" style={{width:'1500px', margin: '1em -3em 0em 1em'}}>
        <TableHead>
          ...
          <TableRow style={{width:'100%'}}>
            ...
            <TableCell align="left" style={{fontWeight:'700',fontSize:'larger'}}>Tên</TableCell>
            <TableCell align="left" style={{fontWeight:'700',fontSize:'larger'}}>Mô tả</TableCell>
